# LONI API — Implementation Status (as of 2026-01-12)

This checklist is generated by comparing the API spec in `API-DOCUMENTATION.md` with what currently exists in the codebase.

## Legend

- **✅ Implemented (Client wired)**: there is a service/repository calling the endpoint.
...
| Endpoint | Consumer app | Admin app | Evidence (where found) |
|---|---:|---:|---|
| GET `/v1/content/:fileId/chunks/:chunkId` | ✅ | ❌ | `loni_backup/lib/features/reading/data/services/reading_api_service.dart` |
| GET `/v1/content/:fileId/sample` | ✅ | ❌ | `loni_backup/lib/features/reading/data/services/reading_api_service.dart` |
| POST `/v1/content/:fileId/preview-token` | ✅ | ❌ | `loni_backup/lib/features/reading/data/services/reading_api_service.dart` |
